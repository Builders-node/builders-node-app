...
import featMeals from '@/assets/adv-meals.jpg';
import featGym from '@/assets/adv-gym.jpg';
import featSpeakers from '@/assets/balaji-srinivasan.png';
import featCommunity from '@/assets/event-community.jpg';
